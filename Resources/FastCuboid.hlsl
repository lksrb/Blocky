...
pixel_shader_input VSMain(vertex_shader_input In, uint vertexID : SV_VertexID)
{
    ...
    float2 TextureCoord[] = { In.TextureCoord0, In.TextureCoord1, In.TextureCoord2, In.TextureCoord3, In.TextureCoord4, In.TextureCoord5 };
    ...
    Out.Color = In.Color;
    Out.TexCoord = TextureCoord[vertexID % 6];
