...
internal texture texture_create(render_backend* Backend, u32 Width, u32 Height, buffer Pixels, bool GenerateMips, texture_format NewFormat, const wchar_t* DebugName)
{
    ...
    D3D12_RESOURCE_DESC TextureDesc = {};
    {
        ...
        TextureDesc.MipLevels = GenerateMips ? dx12_calculate_mip_count(Width, Height) : 1;
    ...
    {
        dx12_render_backend_generate_mips(Backend, Texture.Handle, Width, Height, TextureDesc.MipLevels, Format);
    }
