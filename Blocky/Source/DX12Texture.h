...
static dx12_texture DX12TextureCreate(ID3D12Device* Device, ID3D12GraphicsCommandList* CommandList, buffer Pixels, u32 Width, u32 Height, DXGI_FORMAT Format = DXGI_FORMAT_R8G8B8A8_UNORM)
{
    ...
    const u32 Channels = 4; // RGBA for not
